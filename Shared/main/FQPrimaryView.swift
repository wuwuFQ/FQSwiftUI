...
struct FQPrimaryView: View {
    ...
    private let listData: [ListData] = [
        ListData(sectionIndex: 0, sectionText: "基础控件", sectionData: [
            ...
            ListData.SectionData(index: 5, title: "AsyncImage", subTitle: "异步加载图片"),
            ListData.SectionData(index: 6, title: "ColorPicker", subTitle: "颜色选择器、调色板"),
            ListData.SectionData(index: 7, title: "DisclosureGroup", subTitle: "展开和隐藏的分组"),
            ListData.SectionData(index: 8, title: "Link", subTitle: "跳转浏览器打开"),
            ListData.SectionData(index: 9, title: "Menu", subTitle: "菜单选择控件，点按/长按"),
            ListData.SectionData(index: 10, title: "Label", subTitle: "更像UIButton，一个图片和文字的组合"),
            ListData.SectionData(index: 11, title: "searchable", subTitle: "搜索框"),
        ...
        ListData(sectionIndex: 1, sectionText: "选择器", sectionData: [
            ...
            ListData.SectionData(index: 2, title: "Slider/ProgressView", subTitle: "滑块和进度器"),
    ...
    var body: some View {
        ...
        }.navigationTitle("FQSwiftUI基础")
            .onAppear {
                FQUtil.tabBarHidden(hidden: false)
            }

    }
}

struct FQPrimaryView_Previews: PreviewProvider {
